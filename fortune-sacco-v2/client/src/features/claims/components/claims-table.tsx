...
import { claimsColumns as columns } from './claims-columns'
...
export function ClaimsTable({ data, total, search, navigate }: DataTableProps) {
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter claims by ID...'
        searchKey='id'
        filters={[
          {
            columnId: 'status',
